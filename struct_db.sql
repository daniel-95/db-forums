...
CREATE TABLE `follow` (
  ...
  CONSTRAINT `follow_ibfk_1` FOREIGN KEY (`followee`) REFERENCES `user` (`email`),
  CONSTRAINT `follow_ibfk_2` FOREIGN KEY (`follower`) REFERENCES `user` (`email`)
...
CREATE TABLE `post` (
  ...
  KEY `user` (`user`),
  KEY `thread_date_id` (`thread_id`,`date`,`id`),
  ...
  CONSTRAINT `post_ibfk_3` FOREIGN KEY (`thread_id`) REFERENCES `thread` (`id`),
  CONSTRAINT `post_ibfk_4` FOREIGN KEY (`user`) REFERENCES `user` (`email`)
...
CREATE TABLE `subscription` (
  ...
  CONSTRAINT `subscription_ibfk_2` FOREIGN KEY (`thread_id`) REFERENCES `thread` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-05-12 19:37:46
